...
public class LoginUserCommandHandler : IRequestHandler<LoginUserCommand, LoginUserViewModel>
{
    ...
    public async Task<LoginUserViewModel> Handle(LoginUserCommand request, CancellationToken cancellationToken)
    {
        ...
        if (dbUser.Password != request.Password) // Burası Daha sonradan tekrar düzenlenecek çünkü test ederken kullandığımız şifreler kriptolanmış zaten, pass değişkeniyle tekrar requestin şifrelerini kriptolamaya gerek yok hata alırız.
